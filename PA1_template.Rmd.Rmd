...
Imputing using mean from a specific data is not feasible as data does not exist for a particular date with missing values.  So I'm imputing using a mean for the whole variable. The replica of orginal data is dat here. 
